...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${BASE}/kuwait-cme`,              lastModified: D_CONTENT, changeFrequency: "monthly", priority: 0.95 },
    { url: `${BASE}/bahrain-cme`,             lastModified: D_CONTENT, changeFrequency: "monthly", priority: 0.95 },
    { url: `${BASE}/oman-cme`,                lastModified: D_CONTENT, changeFrequency: "monthly", priority: 0.95 },
