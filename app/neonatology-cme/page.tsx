      ...
      <div className="min-h-screen bg-[#f8fafc]">
        ...
        <main className="max-w-5xl mx-auto px-6 py-12">
          ...
          <div className="bg-[#0f1f3d] rounded-2xl px-8 py-10 text-center mb-10">
            ...
            <p className="text-[#94a3b8] mb-6 max-w-md mx-auto">Log AAP, NRP, and ESPR certificates — monitor all GCC licensing authority targets from one dashboard. Free for all neonatologists.</p>
