...
export const metadata: Metadata = {
  title: "CME Requirements for Pharmacists 2026 — GCC & Global Pharmacist CPD Guide | Hayya Med Pro",
  description:
  ...
  openGraph: {
    ...
    description: "Qatar · Saudi Arabia · UAE · UK — pharmacist CME and CPD requirements worldwide.",
      ...
      <div className="min-h-screen bg-[#f8fafc]">
        ...
        <header className="bg-white border-b border-[#e2e8f0]">
          <div className="max-w-5xl mx-auto px-6 py-16">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xs font-bold text-[#1a56a0] bg-[#dbeafe] px-2.5 py-1 rounded-full uppercase tracking-wide">Pharmacists · GCC & Global</span>
            </div>
            <h1 className="text-4xl font-bold text-[#0f1f3d] tracking-tight mb-5 leading-tight max-w-3xl">
              CME requirements for pharmacists — every country, every authority
            </h1>
            <p className="text-lg text-[#64748b] max-w-2xl leading-relaxed mb-8">
              ...
              or a community pharmacist in the UAE — Hayya Med Pro tracks your compliance automatically.
            </p>
        ...
        <main id="main-content" className="max-w-5xl mx-auto px-6 py-12 space-y-14">
          ...
          <section aria-labelledby="requirements-heading">
            ...
            <div className="space-y-3">
              {[
                ...
                { flag: "🇬🇧", country: "United Kingdom", authority: "GPhC", credits: "35 hours CPD", cycle: "Annual", slug: "united-kingdom" },
                { flag: "🇦🇺", country: "Australia", authority: "AHPRA / PSA", credits: "40 hours CPD", cycle: "Annual", slug: "australia" },
          ...
          <section aria-labelledby="faq-heading">
            <h2 id="faq-heading" className="text-2xl font-bold text-[#0f1f3d] mb-6">Pharmacist CME — frequently asked questions</h2>
          ...
          <section className="bg-[#1a56a0] rounded-2xl p-8 text-center text-white">
            <h2 className="text-2xl font-bold mb-3">Track your pharmacy CME — free</h2>
