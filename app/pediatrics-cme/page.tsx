...
const AUTHORITIES = [
  ...
  { flag: "🇸🇦", name: "SCFHS", country: "Saudi Arabia", term: "CME", credits: "60", cycle: "1 year", note: "SPA events recognized" },
        ...
        <main className="max-w-4xl mx-auto px-6 py-12">
          <div className="text-center mb-14">
            <div className="inline-flex items-center gap-2 bg-[#eff6ff] border border-[#bfdbfe] text-[#1e40af] text-xs font-semibold px-3 py-1.5 rounded-full mb-5">
              👶 Pediatrics · All GCC Licensing Authorities
            </div>
          ...
          <div className="mb-10">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {[
                ...
                { href: "/nurse-cpd", label: "Nursing CPD", icon: "👩‍⚕️" },
