...
export default async function OwnerIntegrationsPage() {
  ...
  const integrations = [
    ...
    },
    {
      ...
      description: "Gemini Flash Lite for every AI feature — chatbot, gap analysis, OCR, analyzers, forecasting (us-east5 region). Claude/Anthropic fully removed 2026-07-04.",
