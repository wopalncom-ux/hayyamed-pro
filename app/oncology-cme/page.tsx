  ...
  return (
    <>
      ...
      <BreadcrumbJsonLd items={[
        ...
        { name: "Oncology CME", url: "https://hayyamed.pro/oncology-cme" },
      ]} />
      <MedicalWebPageJsonLd
        name="Oncology CME"
        url="https://hayyamed.pro/oncology-cme"
        description="CME and CPD requirements for oncologists in GCC. QCHP Qatar 80 CPD/2yr, SCFHS Saudi Arabia 60 CME/yr, DHA Dubai 40 CME/2yr. Track oncology CME across all 7 GCC licensing authorities."
        keywords={["oncology CME requirements GCC", "oncologist CME Saudi Arabia", "SCFHS oncology CME", "QCHP oncologist CPD", "oncology CPD Qatar", "medical oncology CME GCC"]}
      />
