  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-sm text-[#64748b] mt-1">{authority.orgName} — jurisdiction {authority.jurisdictionCountry}</p>
      </div>
      ...
      <div className="bg-white rounded-xl border border-[#e2e8f0] p-6">
        ...
        <p className="text-sm text-[#64748b] mb-5">
          Export jurisdiction compliance data for your records, audit submissions, or regulatory reporting. All exports are audit-logged.
        </p>

        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <a href="/api/government/export-registry" className="flex items-center gap-3 border border-[#e2e8f0] rounded-xl p-4 hover:bg-[#f8fafc] transition-colors group">
          ...
          <a href="/api/pdf/government-report" className="flex items-center gap-3 border border-[#e2e8f0] rounded-xl p-4 hover:bg-[#f8fafc] transition-colors group">
