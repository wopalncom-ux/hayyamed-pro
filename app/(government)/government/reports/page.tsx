    ...
    <div>
      ...
      <div className="bg-white rounded-xl border border-[#e2e8f0] p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="flex items-center gap-3 border border-[#e2e8f0] rounded-xl p-4 opacity-50 cursor-not-allowed">
            ...
            <div>
              <p className="text-sm font-medium text-[#374151]">PDF Aggregate Report</p>
              <p className="text-xs text-[#94a3b8] mt-0.5">Coming soon</p>
            </div>
          </div>
        </div>
