    ...
    <div className="min-h-screen flex">
      ...
      <aside className="hidden lg:flex lg:w-[420px] xl:w-[480px] flex-col bg-[#0f1f3d] px-10 py-12 flex-shrink-0">
        ...
        <a href="/" className="flex items-center gap-2.5 mb-12 group">
          ...
          <span className="text-lg font-bold text-white group-hover:text-[#60a5fa] transition-colors">Hayya Med <span className="text-[#60a5fa]">Pro</span></span>
        </a>
      ...
      {/* Right panel — form */}
      <main id="main-content" className="flex-1 flex items-center justify-center px-4 py-12 bg-[#f8fafc]">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden text-center mb-8">
            <a href="/" className="inline-flex items-center justify-center gap-2 mb-2 group">
              ...
              <span className="text-xl font-bold text-[#1a56a0] group-hover:text-[#1547a0] transition-colors">Hayya Med Pro</span>
            </a>
            <p className="text-sm text-[#64748b]">Healthcare Professional Platform</p>
          </div>
          {/* Desktop back-to-home link */}
          <div className="hidden lg:flex justify-end mb-4">
            <a href="/" className="inline-flex items-center gap-1.5 text-xs text-[#64748b] hover:text-[#1a56a0] transition-colors">
