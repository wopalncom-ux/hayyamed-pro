...
export const metadata: Metadata = {
  title: "Radiology CME Requirements in GCC — Radiologist CME Guide | Hayya Med Pro",
  description:
  ...
  openGraph: {
    title: "Radiology CME Requirements in GCC — Complete Radiologist Guide",
    description:
      "QCHP, SCFHS, DHA, DOH — CME requirements for radiologists. Radiation safety, AI imaging, Saudi Radiology Society events, and GCC licensing guidance.",
...
const AUTHORITIES = [
  ...
  { flag: "🇸🇦", name: "SCFHS", country: "Saudi Arabia", term: "CME", credits: "60", cycle: "1 year", note: "SRS events recognized" },
        ...
        <main className="max-w-4xl mx-auto px-6 py-12">
          <div className="text-center mb-14">
            <div className="inline-flex items-center gap-2 bg-[#eff6ff] border border-[#bfdbfe] text-[#1e40af] text-xs font-semibold px-3 py-1.5 rounded-full mb-5">
              🩻 Radiology · All GCC Licensing Authorities
            </div>
          ...
          <div className="bg-white rounded-2xl border border-[#e2e8f0] overflow-hidden mb-10 shadow-sm">
            <div className="px-6 py-5 border-b border-[#f1f5f9]">
              ...
              <p className="text-sm text-[#64748b] mt-1">General physician requirements apply to radiologists — radiation safety and specialty CME all count</p>
            </div>
          ...
          <div className="mb-12">
            <h2 className="text-xl font-bold text-[#111] mb-6">Radiology CME — frequently asked questions</h2>
          ...
          <div className="mb-10">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {[
                ...
                { href: "/allied-health-cpd", label: "Allied Health", icon: "🦿" },
          ...
          <div className="bg-gradient-to-br from-[#0f1f3d] to-[#1a3563] rounded-2xl p-10 text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-2">Track your radiology CME — free</h2>
