...
export const metadata: Metadata = {
  title: "Surgery CME Requirements in GCC — General Surgeon CME Guide | Hayya Med Pro",
  description:
  ...
  openGraph: {
    title: "Surgery CME Requirements in GCC — General Surgeon CME Guide",
    description:
      "QCHP, SCFHS, DHA, DOH — CME and CPD requirements for general surgeons and surgical specialists. ATLS, laparoscopic workshops, and ACS events guidance.",
...
const AUTHORITIES = [
  ...
  { flag: "🇸🇦", name: "SCFHS", country: "Saudi Arabia", term: "CME", credits: "60", cycle: "1 year", note: "Saudi Surgical Society" },
...
const SPECIALTY_NOTES = [
  {
    ...
    body: "Laparoscopic simulation, robotic training, endoscopy, and open surgical skills courses from accredited centers count as CME across GCC authorities — often at higher credit weights.",
  },
  {
    icon: "🚑",
  ...
  return (
    <>
      ...
      <BreadcrumbJsonLd items={[
        ...
        { name: "Surgery CME", url: "https://hayyamed.pro/surgery-cme" },
      ]} />
      <MedicalWebPageJsonLd
        name="Surgery CME Requirements in GCC"
        url="https://hayyamed.pro/surgery-cme"
        description="Complete CME guide for surgeons in Qatar, Saudi Arabia, UAE, Kuwait, Bahrain, and Oman."
        keywords={["surgery CME GCC", "surgeon CME requirements Qatar", "QCHP surgery CPD", "SCFHS surgeon CME", "GCC surgeon license renewal"]}
      />
        ...
        <main className="max-w-4xl mx-auto px-6 py-12">
          <div className="text-center mb-14">
            <div className="inline-flex items-center gap-2 bg-[#eff6ff] border border-[#bfdbfe] text-[#1e40af] text-xs font-semibold px-3 py-1.5 rounded-full mb-5">
              🔪 Surgery · All GCC Licensing Authorities
            </div>
          ...
          <div className="bg-white rounded-2xl border border-[#e2e8f0] overflow-hidden mb-10 shadow-sm">
            <div className="px-6 py-5 border-b border-[#f1f5f9]">
              ...
              <p className="text-sm text-[#64748b] mt-1">General physician requirements apply to surgeons — ATLS and procedural workshops count toward these totals</p>
            </div>
          ...
          <div className="mb-12">
            <h2 className="text-xl font-bold text-[#111] mb-6">Surgery CME — frequently asked questions</h2>
          ...
          <div className="mb-10">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {[
                ...
                { href: "/emergency-medicine-cme", label: "Emergency Med", icon: "🚑" },
          ...
          <div className="bg-gradient-to-br from-[#0f1f3d] to-[#1a3563] rounded-2xl p-10 text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-2">Track your surgery CME — free</h2>
            <p className="text-[rgba(255,255,255,0.65)] mb-6 max-w-md mx-auto text-sm">
              Log ATLS, surgical workshops, ACS conferences, and online courses — all in one wallet. Set up your QCHP or SCFHS wallet in under 2 minutes.
            </p>
