      ...
      <div className="min-h-screen bg-[#f8fafc]">
        ...
        <main className="max-w-5xl mx-auto px-6 py-12">
          ...
          <div className="bg-[#0f1f3d] rounded-2xl px-8 py-10 text-center mb-10">
            ...
            <p className="text-[#64748b] mb-6 max-w-md mx-auto">Log AANS, CNS, and EANS certificates — track all GCC license targets in one place. Free for all neurosurgeons.</p>
