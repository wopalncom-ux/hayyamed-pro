...
export const metadata: Metadata = {
  title: "CPD Requirements for Physiotherapists 2026 â€” GCC & Global PT Guide | Hayya Med Pro",
  description:
  ...
  openGraph: {
    ...
    description: "Qatar Â· Saudi Arabia Â· UAE Â· UK Â· Australia â€” physiotherapist CPD requirements worldwide.",
...
const faqLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes â€” in most GCC countries, physiotherapists, doctors, and nurses are all required to complete the same total credit requirement (e.g., 80 CPD per 2 years in Qatar). However, the mandatory topics and accepted activities may be profession-specific. QCHP, SCFHS, and DHA all apply the same credit totals to all licensed healthcare professionals.",
      },
    },
  ],
};
      ...
      <div className="min-h-screen bg-[#f8fafc]">
        ...
        <header className="bg-white border-b border-[#e2e8f0]">
          <div className="max-w-5xl mx-auto px-6 py-16">
            <div className="flex items-center gap-2 mb-4">
              <span className="text-4xl" aria-hidden="true">ðŸƒ</span>
              <span className="text-xs font-bold text-[#1a56a0] bg-[#dbeafe] px-2.5 py-1 rounded-full uppercase tracking-wide">Physiotherapists Â· Allied Health</span>
            </div>
            <h1 className="text-4xl font-bold text-[#0f1f3d] tracking-tight mb-5 leading-tight max-w-3xl">
              CPD requirements for physiotherapists â€” every country, every authority
            </h1>
        ...
        <main id="main-content" className="max-w-5xl mx-auto px-6 py-12 space-y-14">
          ...
          <section aria-labelledby="requirements-heading">
            ...
            <div className="space-y-3">
              {[
                ...
                { flag: "ðŸ‡¬ðŸ‡§", country: "United Kingdom", authority: "HCPC", credits: "30 hours CPD", cycle: "2 years", slug: "united-kingdom" },
                { flag: "ðŸ‡¦ðŸ‡º", country: "Australia", authority: "AHPRA / APA", credits: "Varies", cycle: "Annual", slug: "australia" },
          ...
          <section aria-labelledby="faq-heading">
            <h2 id="faq-heading" className="text-2xl font-bold text-[#0f1f3d] mb-6">Physiotherapist CPD â€” frequently asked questions</h2>
          ...
          <section className="bg-[#1a56a0] rounded-2xl p-8 text-center text-white">
            <h2 className="text-2xl font-bold mb-3">Track your physio CPD â€” free</h2>
