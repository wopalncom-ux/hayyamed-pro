    ...
    <Document title="CME Compliance Report" author="Hayya Med Pro">
      <Page size="A4" style={styles.page}>
        ...
        {pendingActivities.length > 0 && (
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>Pending Activities — Awaiting Verification ({pendingActivities.length})</Text>
        ...
        <View style={styles.footer} fixed>
          ...
          <Text>Verified credits counted. Pending activities shown for reference only — not for submission.</Text>
        </View>
      </Page>
    </Document>
  );
