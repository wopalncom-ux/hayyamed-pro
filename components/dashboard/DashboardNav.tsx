...
export default function DashboardNav({
  ...
  const NAV_ITEMS = [
    { href: "/dashboard", label: t("nav_overview"), Icon: LayoutDashboard, owns: ["/dashboard"] },
    { href: "/dashboard/cme", label: t("nav_cme"), Icon: BookOpen, owns: ["/dashboard/cme", "/dashboard/certificates", "/dashboard/passport"] },
  ...
  const navItems = [
    ...NAV_ITEMS,
    ...(isEmployerAdmin ? [{ href: "/employer", label: t("nav_employer"), Icon: Building2, owns: ["/employer"] }] : []),
  ];
      ...
      >
        ...
        >
          ...
          <div className="px-4 py-3 border-b border-[#e2e8f0]">
            <p className="text-xs text-[#64748b] uppercase tracking-wide mb-0.5">{t("nav_signed_in_as")}</p>
